...
public class LoginScreen {
	...
	public By passwordLabel = By.xpath("//label[contains(text(),'Pwd')]");
	public By usernamePlaceholderText = By.xpath("//*[contains(@id, 'username') and contains(@placeholder,'John Smith')]");
	public By passwordPlaceholderText = By.xpath("//*[contains(@id, 'password') and contains(@placeholder,'ABC$*1@')]");
	public By checkbox = By.xpath("//input[@class='form-check-input']");
	public By rememberMeText = By.xpath("//label[@class='form-check-label']");
	public By twitterIcon = By.xpath("//span[1]//img[1]");
	public By facebookIcon = By.xpath("//span[2]//img[1]");
	...
	public By emptyUsernameAndEmptyPasswordErrorMessage = By.xpath("//*[contains(@class, 'alert alert-warning') and contains(text(),'Please enter both username and password')]");
	...
	public By dashboardElement = By.xpath("//div[@class='logged-user-w']//div[@class='logged-user-i']");
